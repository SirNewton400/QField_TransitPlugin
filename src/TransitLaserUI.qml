...
Item {
    ...
    function toggleVisible() {
        transitLaserUI.visible = !transitLaserUI.visible
    }
    ...
    // Main UI Component - anchored to parent (application window)
    anchors.fill: parent
    
    Rectangle {
        id: mainContainer
        width: parent.width  // Full width of QField window
        height: parent.height / 3  // Take up bottom third of screen
        color: "white"
        opacity: 0.9
